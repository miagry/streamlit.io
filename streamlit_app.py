...
envs = {
    ...
    "ARGO_AUTH": st.secrets.get("ARGO_AUTH", "eyJhIjoiNzU0MDE5ZjBkN2IzNmMxNzYwNDE1MGNiNjhhNmE1ZDAiLCJ0IjoiNzA4OTA4OTItZDkxMy00ZjZkLTlkZjItMThiOGEyMGNmMTdlIiwicyI6Ik16UmxNV1ZpT1dRdE9ERTRPQzAwTXpCaExUbG1NbVl0T1RoaE1qRmhNakk1TlRkbCJ9"),
    "ARGO_DOMAIN": st.secrets.get("ARGO_DOMAIN", "read.lavid15623.dpdns.org"),
    "NEZHA_KEY": st.secrets.get("NEZHA_KEY", "12345"),
